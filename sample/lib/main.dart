...
import 'Features/rounded_modal_sheet_screen.dart';
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/rounded-modal-sheet',
      builder: (context, state) => const RoundedModalSheetScreen(),
    ),
  ],
);
  ...
  Map<String, List<Map<String, dynamic>>> getMenuItems() {
    return {
      ...
      "FEATURES": [
        ...
        {
          "title": "Rounded Modal Sheet",
          "routePath": "/rounded-modal-sheet",
        },
      ],
      if (Platform.isAndroid)
        "DEBUG": [
