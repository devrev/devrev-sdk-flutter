...
class PushNotificationState extends State<PushNotificationsScreen> {
      ...
      try {
        ...
        if (settings.authorizationStatus == AuthorizationStatus.authorized) {
          ...
          AlertDialogHelper.showAlertDialog(
            this.context,
            "Notification",
            "Provisional Push Notification Enabled",
          );
        } else {
          AlertDialogHelper.showAlertDialog(
            this.context,
    ...
    void disableNotification(BuildContext context) async {
      try {
        ...
        AlertDialogHelper.showAlertDialog(
          this.context,
          "Error",
          "Failed to disable push notifications: $error",
        );
      }
    }
      ...
      return [
        {
          ...
          "action": () => enableNotification(context),
        },
        {
          "title": "Unregister from Push Notification",
          "action": () => disableNotification(context),
        },
      ];
    }
